...
Insert into userinfos(id,studyAt,workingAt,otherInfo,dateOfBirth,avatarUrl) values(1,'Học tại PTIT', 'FPT', 'FPT','2/2/2003','http://avatar.png');
Insert into userinfos(id,studyAt,workingAt,otherInfo,dateOfBirth,avatarUrl) values(2,'Học tại FPT', 'VNG', 'VNG','23/5/2003','http://avatar.png');
Insert into userinfos(id,studyAt,workingAt,otherInfo,dateOfBirth,avatarUrl) values(3,'Học tại FTU', 'RIOT', 'RIOT','20/4/2003','http://avatar.png');
